...
func (g *Generator) generateResourceConversions(resource string) string {
	...
	b.WriteString("import (\n")
	fmt.Fprintf(&b, "\tv1alpha1 \"%s\"\n", g.CRDPackage)
	b.WriteString("\t\"github.com/openshift-online/rosa-hyperfleet-api/hack/api-codegen/pkg/conversion\"\n")
	fmt.Fprintf(&b, "\t\"github.com/openshift-online/rosa-hyperfleet-api/hack/api-codegen/pkg/conversion/%s/rest\"\n", g.APIVersion)
	b.WriteString(")\n\n")
